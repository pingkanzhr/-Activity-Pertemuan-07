...
import crud.ktp.project.ktp.exceptions.NonexistentEntityException;
import crud.ktp.project.ktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("crud.ktp_project.ktp_jar_0.0.1-SNAPSHOTPU");
